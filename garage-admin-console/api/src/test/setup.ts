...
// Isolate this BFF's LibSQL file DB in its own throwaway temp dir, overriding
...
// second migrator skips table creation ("no such table: Cluster").
process.env.DATA_DIR = mkdtempSync(join(tmpdir(), 'garage-admin-api-test-'));
