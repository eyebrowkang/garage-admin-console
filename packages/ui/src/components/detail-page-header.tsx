...
export interface DetailPageHeaderProps {
  /** When provided, renders a styled back button that calls this on click. */
  onBack?: () => void;
  backLabel?: string;
  title: ReactNode;
  subtitle?: ReactNode;
...
/**
 * Detail-level page header: optional back button, title + badges, subtitle and
 * a trailing actions cluster. Router-agnostic — consumers wire navigation via
 * `onBack` (e.g. a react-router navigate call) so this stays usable in the
