        ...
        <div className="space-y-8">
            ...
            <Tabs defaultValue="overview" className="space-y-6">
                <TabsList className="bg-slate-100/50 p-1 border flex flex-wrap">
                    ...
                    <TabsTrigger value="layout" className="data-[state=active]:bg-white data-[state=active]:shadow-sm">Layout</TabsTrigger>
                    <TabsTrigger value="api" className="data-[state=active]:bg-white data-[state=active]:shadow-sm">API Explorer</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="layout" className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
                    <LayoutManager clusterId={id} />
                </TabsContent>
                <TabsContent value="api" className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
