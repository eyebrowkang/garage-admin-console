...
interface EmbedDeleteDialogProps {
  open: boolean;
...
export function EmbedDeleteDialog({
  open,
  onOpenChange,
  onConfirm,
  isLoading,
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            {isFolder ? ' This only deletes the folder marker.' : ' This action cannot be undone.'}
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
