...
import { BucketObjectBrowserCard } from '@/components/cluster/BucketObjectBrowserCard';
...
const RemoteS3EmbedProvider = lazy(() =>
  import('s3_browser/S3EmbedProvider').then((module) => ({ default: module.S3EmbedProvider })),
);

const RemoteObjectBrowser = lazy(() =>
  import('s3_browser/ObjectBrowser').then((module) => ({ default: module.ObjectBrowser })),
);
  ...
  return (
    <div className="space-y-6">
      ...
      <BucketObjectBrowserCard
        ...
        clusterId={clusterId}
        keys={bucket.keys}
        EmbedProvider={RemoteS3EmbedProvider}
        ObjectBrowser={RemoteObjectBrowser}
      />
